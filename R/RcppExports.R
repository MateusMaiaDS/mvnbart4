...
truncated_sample <- function(mu, left, sigma_) {
    .Call('_mvnbart4_truncated_sample', PACKAGE = 'mvnbart4', mu, left, sigma_)
}
...
cppbart_CLASS <- function(x_train, y_mat, x_test, x_cut, n_tree, node_min_size, n_mcmc, n_burn, Sigma_init, mu_init, sigma_mu, nu, alpha, beta, m, update_sigma, var_selection_bool, tn_sampler) {
    .Call('_mvnbart4_cppbart_CLASS', PACKAGE = 'mvnbart4', x_train, y_mat, x_test, x_cut, n_tree, node_min_size, n_mcmc, n_burn, Sigma_init, mu_init, sigma_mu, nu, alpha, beta, m, update_sigma, var_selection_bool, tn_sampler)
}
